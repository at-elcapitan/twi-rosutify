...
async def process_callback(
    ...
    callback_data: FetchedEntityCallback | TGFetchedEntityCallback
):
    ...
    if isinstance(callback_data, FetchedEntityCallback):
        ...
        if await notify_entity_db.is_tg_message_picked(session, entity_id):
            await callback.answer("This message has already been taken by someone else.", show_alert=True)
            return
